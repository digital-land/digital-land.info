...
1. **One page per record** <br>Give each record its own webpage so that the documentation-url is the full page address. For example `yourwebsite.gov.uk/planning/article-4-directions/smith-road`.</br>
