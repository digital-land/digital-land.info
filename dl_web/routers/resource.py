...
def resource_index(request: Request, page: Optional[int] = 1):
    paging = DigitalLandModelJsonQuery().get_paging(key="resource", table="resource")[
        "rows"
    ]
    ...
    return templates.TemplateResponse(
        "index.html",
        {
            ...
            "collection": {},
            "resources": resources,
            "paging": {"current_page": page, "total_pages": len(paging) + 1},
        },
    )
