            ...
            [
                {
                    ...
                    "reference": "CA1",
                    "geometry": "MULTIPOLYGON(((-0.39877874932762813 52.37557396590839,-0.49691286828496717 52.31309909388361,-0.3325311902998525 52.28924588007146,-0.280273249515528 52.35293530122911,-0.39877874932762813 52.37557396590839)))",  # noqa E501
                },
                {
                    "entity": 2,
                    "reference": "CA2",
                ...
                },
                {
                    ...
                    "geometry": "MULTIPOLYGON(((-0.7489300741242954 52.4863973669523,-0.9505678287521635 52.27316949066329,-0.3760369581498711 52.142463344337585,-0.21381926107403462 52.37856061047788,-0.7489300741242954 52.4863973669523)))",  # noqa E501
                },
            ],
        ...
        (
            [
                ...
                },
                {
                    ...
                    "reference": "LPLAD1",
                    "dataset": "local-authority-district",
                    "geometry": "MULTIPOLYGON(((-0.07955040597019639 52.51338781409572,-0.5510502032408139 52.32210614595394,0.03009961574087244 52.18134255828252,-0.07955040597019639 52.51338781409572)))",  # noqa E501
                },
            ],
            {"dataset": ["conservation-area"], "geometry_reference": ["LPLAD1"]},
            2,
...
def test__apply_location_filters_with_frz(db_session):
...
entities = [
    {
        ...
        "dataset": "conservation-area",
        "reference": "CA1",
        "geometry": "MULTIPOLYGON(((-0.3 52.4, -0.4 52.3, -0.2 52.3, -0.3 52.4)))",
    },
    {
        "entity": 2,
        "dataset": "flood-risk-zone",
        "reference": "FRZ1",
        "geometry": "MULTIPOLYGON(((-6.31 49.81, -6.29 49.81, -6.29 49.79, -6.31 49.79, -6.31 49.81)))",
    },
]
